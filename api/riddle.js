...
const OUTPUT_SCHEMA = {
  ...
  schema: {
    ...
    properties: {
      ...
      reply: {
        type: "string",
        description: "トム・リドルとしての返事の全文。ready=false なら空文字",
      },
      script: {
        type: "array",
        description:
          "返事の演出スクリプト。text を順に連結すると reply と一致する。ready=false なら空配列",
        items: {
          type: "object",
          properties: {
            text: { type: "string" },
            ...
            emphasis: {
              type: "boolean",
              description: "感情が昂ぶる句だけ true(全体で0〜2箇所)",
            },
          },
      ...
      memory: {
        type: "boolean",
        description:
          "使用者が日記の過去の核心に踏み込み、記憶を見せるときだけ true",
      },
    },
